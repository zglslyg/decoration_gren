...
//		    offsetChildren(up ? movedBy : -movedBy);
		    //lyl modify at 130911
            if(movedBy>mItemTopMargin){
            	offsetChildren(up ? movedBy : -movedBy);
	...
	private final boolean contentFits() {
		return false;
		//lyl remove at 20130817 for layout can't scroll bug begin
...
//				&& bottommost <= getHeight() - getPaddingBottom();
		//lyl remove at 20130817 for layout can't scroll bug end
	}
